...
функция-генератор выдаёт список из 1000 паролей и закидывает в каждый поток


В файле password_picker_MP.py содержится многопроцессорный подборщик 
Принцип работы такой - исходя из заданного диапазона возможных вариантов 
скрипт делит исходный массив паролей на 4 процесса
функция-генератор выдаёт список из 1000 паролей и закидывает в каждый процесс
